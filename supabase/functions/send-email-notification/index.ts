        ...
        <div class="container">
          ...
          <div class="order-details">
            <div class="detail-row">
              <span class="label">Order ID:</span> ${order_data.order_id}
            </div>
            <div class="detail-row">
              <span class="label">Customer:</span> ${order_data.first_name} ${order_data.last_name}
            </div>
            <div class="detail-row">
              <span class="label">Email:</span> ${order_data.email}
            </div>
            <div class="detail-row">
              <span class="label">Phone:</span> ${order_data.phone}
            </div>
            <div class="detail-row">
              <span class="label">Operation:</span> ${order_data.operation_type}
            </div>
            <div class="detail-row">
